...
const Contact = async ({params}) => {
    ...
    return (
       <div>
        ...
        <Team />
        <Ourbranch />
            <div className='block lg:flex  gap-20 items-center p-6 lg:mx-28 py-20'>
                <div className='w-full lg:w-[50%]'>
                    <div className='' >

                        <h3 className='text-4xl'>{t("Contact Us")}</h3>
                        <div className='border-red-600 my-3 w-[20%] lg:w-[13%] border-t-8 rounded-lg ' />

                        <p className='text-[16px] text-slate-600 w-[80%] py-4'>{t("If you have an inquiry, we are happy to receive your inquiry at any time.")}</p>
                    </div>
                    <div>
